...
public class DisruptorMetrics {
     ...
     * Records Prometheus metrics when utilization is high.
     */
    ...
    public void logRingBufferUtilization() {
        ...
        // Update gauge value in MetricsCollector
        metricsCollector.updateRingBufferUtilization(utilization);
        
        if (utilization > HIGH_UTILIZATION_THRESHOLD) {
            // Record high utilization event
            metricsCollector.recordRingBufferHighUtilization(utilization, remainingCapacity);
